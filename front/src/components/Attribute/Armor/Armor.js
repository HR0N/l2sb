...
function Armor(props) {
    ...
    return(<div className={`Armor`}>
        ...
        <div className="att att1">
            <div className="title">{att[props.data[0][0]][0]} Lv {get_lvl(props.data[0][1])} ({att[props.data[0][0]][1]} Физ. Защ. {props.data[0][1]})</div>
        ...
        {props.data[1][1] ?
            <div className="att att2">
                <div className="title">{att[props.data[1][0]][0]} Lv {get_lvl(props.data[1][1])} ({att[props.data[1][0]][1]} Физ. Защ. {props.data[1][1]})</div>
                <div className="progress">
        ...
        {props.data[2][1] ?
            <div className="att att3">
                <div className="title">{att[props.data[2][0]][0]} Lv {get_lvl(props.data[2][1])} ({att[props.data[2][0]][1]} Физ. Защ. {props.data[2][1]})</div>
                <div className="progress">
