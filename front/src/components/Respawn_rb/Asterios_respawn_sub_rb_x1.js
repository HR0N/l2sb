    ...
    >
        ...
        {rss_x1 ?
            <div className={`key_bosses_cards`}>
                <Card idx={0} data={rss_x1[1].Cabrio} link={link} gmt={gmt}/>
                <Card idx={1} data={rss_x1[1].Hallate} link={link} gmt={gmt}/>
                <Card idx={2} data={rss_x1[1].Kernon} link={link} gmt={gmt}/>
                <Card idx={3} data={rss_x1[1].Golkonda} link={link} gmt={gmt}/>
            </div>
            : false}
    </div>);
}
